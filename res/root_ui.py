...
class Ui_ICEHelper(object):
    ...
    def retranslateUi(self, ICEHelper):
        ...
        self.file_label.setText(_translate("ICEHelper", "文件"))
        self.file_lineEdit.setPlaceholderText(_translate("ICEHelper", "file dir"))
        self.sheet_lineEdit.setPlaceholderText(_translate("ICEHelper", "sheet or null"))
        self.file_read_pbtn.setText(_translate("ICEHelper", " 读取"))
        self.filter_label.setText(_translate("ICEHelper", "筛选字符"))
        self.filter_pbtn.setText(_translate("ICEHelper", "筛选"))
        self.checkBox.setText(_translate("ICEHelper", "分文件输出"))
        self.output_pushButton.setText(_translate("ICEHelper", "输出"))
