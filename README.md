...
+ mac 打包命令
  ...
  ``` shell
  pyinstaller --onefile --windowed --icon res/img/apple.ico --add-data res/img/file70.svg:res/img --add-data res/img/apple.svg:res/img --hidden-import PyQt5.sip --name ICEHelper_mac Main.py
  ```
